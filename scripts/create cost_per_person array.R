...
dat <-
  readxl::read_excel("C:/Users/ngreen1/Google Drive/TB outbreak costing/costing xls tools/TB_incident_contact_tracing_costing/101019-TB_incident_contact_tracing_costing-Birmingham.xlsm",
